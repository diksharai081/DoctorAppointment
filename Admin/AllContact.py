...
<html>
	<head>
		...
		<title>Doctor Appointment | All Contact</title>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">All Contact Data</li>
				</ol>
			</div><!--/.row-->
...
for row in data:							
  print"""<tr>
    ...
    <td>%s</td>
    <td>%s</td>
	<td><a href="../Manage.py?delid=%s&&flg=9"><i class="fa fa-trash text-danger" title="Data Delete"></i><a/></td>
  </tr>"""%(row[0],row[1],row[2],row[3],row[4],row[5],row[0])									
...
print"""</tbody>
	...
	<div class="col-sm-12">
				<p class="back-link"><b>Powered By :</b><a href="#" target="_blank"><b>Diksha Rai(Kaushambi)</b></a></p>
			</div>
		</div><!-- /.row -->
		</div><!--/.main-->	
