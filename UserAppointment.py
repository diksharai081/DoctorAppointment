...
<html>
	<head>
		...
		<title>Doctor Care | User Appointment</title>
	...
	<body>
		...
		<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
			...
			<ul class="nav menu">
				<li class="active"><a href="Profile.py"><em class="fa fa-dashboard">&nbsp;</em>User Appointment</a></li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">User Appointment Forms</li>
				</ol>
			</div><!--/.row-->
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal row-border" action="Manage.py?flg=14" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label class="col-md-2 control-label">Refer Hospital/Doctor</label>
									<div class="col-md-10">
										<input class="form-control" type="text" name="refer" placeholder="Enter Refer Name">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="col-md-2 control-label">Appointment Day</label>
									<div class="col-md-10">
