...
<html lang="en">
  <head>
    <title>Doctor Care | Appointment</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.py">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Appointment <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    		...
    		<div class="row">
	          ...
	          <form action="Manage.py?flg=4" method="post" class="appointment-form ftco-animate" >
                      ...
                      <select name="service" id="" class="form-control">
	    				...
	    				<div class="d-md-flex">
	    					<div class="form-group">
		              <textarea name="" id="" cols="30" rows="2" class="form-control" placeholder="Message" name="msg"></textarea>
		            </div>
		            <div class="form-group ml-md-4">
            ...
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">diksharai081@gmail.com</span></a></li>
	              </ul>
	            </div>
