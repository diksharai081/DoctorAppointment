...
cursor.execute("select * from userappointment")
...
<html>
	<head>
		...
		<title>Doctor Appointment | User All Appointment</title>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">User All Appointment Data</li>
				</ol>
			</div><!--/.row-->
						...
						<div class="panel-body btn-margins">
							<div class="col-md-12">
								<table class="table table-striped table-bordered">
									<thead>
										<tr>
											<th>User Appoint ID</th>
											<th>User Appoint Name</th>
											<th>User Appoint Mobile</th>
											<th>User Refer By Hospital</th>
											<th>User Location</th>
											<th>User Appoint Book Day</th>
...
for row in data:							
  print"""<tr>
    ...
    <td>%s</td>
    <td>%s</td>
	<td><a href="../Manage.py?delid=%s&&flg=15"><i class="fa fa-trash text-danger" title="Data Delete"></i><a/></td>
  </tr>"""%(row[0],row[2],row[3],row[4],row[5],row[6],row[7],row[0])									
