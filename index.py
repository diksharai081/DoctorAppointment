	    		...
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md-4 pr-4 d-flex topper align-items-center">
						  ...
						  <span class="text">Phone: +917607101498</span>
					    </div>
				    </div>
			    </div>
		    </div>
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p class="text-justify">Consultants are senior doctors that have completed full medical training in a specialised area of medicine and are listed on the GMC's specialist register.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p class="text-justify">Prehospital and facility-based emergency care is a high impact and cost-effective form of secondary prevention. Additionally, disease.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p class="text-justify">Outdoor Checkup. There is an outdoor treatment zone or section in Shubham Hospital for regular health checkups of different disease. From dentist to.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p class="text-justify">Family Physicians Group offers 24 hour medical care. Learn more about our medical services and the 24 hour availability.</p>
              </div>
            </div>      
          </div>
        </div>
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
	          ...
	          <div class="pl-md-5 ml-md-5 mb-5">
							<p>Begin your specialty exploration by reading the profiles of more than 120 specialties and subspecialties. For each, you'll find descriptions.</p>
							<div class="row mt-5 pt-2">
								...
								<div class="col-lg-6">
									<div class="services-2 d-flex">
										...
										<div class="text">
											<h3>Lab Test</h3>
											<p>74 Tests - Liver, Kidney, Thyroid, Heart, CBC, Urine & Sugar.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="services-2 d-flex">
										...
										<div class="text">
											<h3>Symptom Check</h3>
											<p>The WebMD Symptom Checker is designed to help you .</p>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
...
Laboratory tests help doctors determine what is going on within your body.</p>
		...
		<section class="ftco-section ftco-no-pt">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Consultants are senior doctors that have completed full medical training in a specialised area of medicine and are listed on the GMC's specialist register.</p>
          </div>
        </div>	
				<div class="row">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>What patients say in their own words is increasingly being used for many purposes and getting results above and beyond simple patient survey ratings.</p>
          </div>
        </div>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2 bg-light">
                    ...
                    <p>Patient testimonials for Winchester Hospital, north of Boston, Massachusetts, including stories from cancer survivors.</p>
                    <p class="name">Ravi jaiswal</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2 bg-light">
                    ...
                    <p>I would like to pay special attention to the MSICU nurses who I spent the most time with. I can't say enough about the nursing staff in ICU. .</p>
                    <p class="name">Abhay Rai</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2 bg-light">
                    ...
                    <p>Using the patient's worldview to challenge his or her decision and establish a treatment  the view is shared by the physician.</p>
                    <p class="name">Hansh Sharma</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2 bg-light">
                    ...
                    <p>Everyone says Liverpool Heart and Chest is a great hospital but what ... Our Vision is for patients to feel that their care was planned with them and for them.</p>
                    <p class="name">Deen dayal</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2 bg-light">
                    ...
                    <p>Using the patient's worldview to challenge his or her decision and establish.</p>
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <div class="heading-section heading-section-white ftco-animate mb-5">
	            ...
	            <p>Sometimes, just talking to somebody, finding out what you're dealing with, it can help bring some peace of mind.</p>
	          </div>
	          <form action="Manage.py?flg=4" method="post" class="appointment-form ftco-animate">
	    				<div class="d-md-flex">
