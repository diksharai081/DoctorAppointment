...
<html>
	<head>
		...
		<title>Doctor Appointment | All Appointment</title>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">All Appointment Data</li>
				</ol>
			</div><!--/.row-->
								...
								<table class="table table-striped table-bordered">
									<thead>
										<tr>
											...
											<th>Appointment First Name</th>
											<th>Appointment Last Name</th>
											<th>Appointment Services</th>
											<th>Appointment Mobile No</th>
...
for row in data:							
  print"""<tr>
    ...
    <td>%s</td>
    <td>%s</td>
	<td><a href="../Manage.py?delid=%s&&flg=8"><i class="fa fa-trash text-danger" title="Data Delete"></i><a/></td>
  </tr>"""%(row[0],row[1],row[2],row[3],row[4],row[5],row[6],row[0])									
